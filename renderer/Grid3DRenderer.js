...
export class Grid3DRenderer {
    ...
    constructor(wasm, container, crosshair) {
        this.selectedCellType = CellType.WALL;
        this.materialOpacities = new Map();
        this.animationFrameId = null;
        this.keyState = {};
        this.cameraDefaultPosition = new THREE.Vector3(20, 20, 20);
        this.cameraDefaultTarget = new THREE.Vector3(0, 0, 0);
        this.geometry = null;
        this.material = null;
        this.mesh = null;
    ...
    renderGrid() {
        ...
        const colorAttribute = this.geometry.getAttribute('instanceColor');
        ...
        const opacityAttribute = this.geometry.getAttribute('instanceOpacity');
        ...
        const objectsToRemove = this.scene.children.filter(obj => obj.type === 'DirectionalLight' || obj.type === 'AmbientLight' || obj.type === 'AxesHelper' || obj.type === 'GridHelper');
     ...
     */
    setupCameraView(zoomOutFactor = 1.8, startOrbiting = true, orbitSpeed = 0.1) {
        ...
        this.camera.position.set(cameraDistance * 0.7, // Slightly offset X
    ...
    startAutoOrbit(speed = 0.1) {
        ...
        this.animate = () => {
            ...
            if (this.orbitingEnabled) {
                ...
                const currentAngle = Math.atan2(this.camera.position.x - this.controls.target.x, this.camera.position.z - this.controls.target.z);
...
//# sourceMappingURL=Grid3DRenderer.js.map