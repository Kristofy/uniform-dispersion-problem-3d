...
export function createBlockSelector(container: HTMLElement, wasm: WasmExports, renderer: Grid3DRenderer) {
    ...
    const defaultButton = blockTypesGrid.querySelector('[data-block-button]') as HTMLElement;
    if (defaultButton) {
        defaultButton.click();
    }
}
