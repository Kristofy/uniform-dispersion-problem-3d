 ...
 */
function wasmLoad(fileName, imports) {
            ...
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Promise(function (resolve, reject) {
                        ...
                        request.onload = function () {
                            ...
                            var exports = new WebAssembly.Instance(wasmModule, imports).exports;
                            resolve(exports);
                ...
                case 1: return [2 /*return*/, _a.sent()]; // Promise
            }
        });
    });
} // loadWasm()
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wasmLoad("main.wasm", imports)];
                case 1:
                    wasm = _a.sent();
                    console.log(wasm);
